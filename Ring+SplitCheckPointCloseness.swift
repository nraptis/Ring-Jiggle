...
extension Ring {
    ...
    func attemptMeasureSplitQualityPointClosenessNeighbor(index1: Int,
        ...
        let highQualityDistance = (RingSplitQuality.splitQualityPointClosenessNeighborThresholdGreat + Math.epsilon) // need the epsilon for GTE vs GT
        ...
        if neighborDistanceSquared2 < PolyMeshConstants.splitPointNeighborTooCloseToLineSegment {
            return false
        }
        ...
        //let grade1 = RingSplitQuality.classifyPointClosenessNeighbor(theoreticalDistance1)
        //let grade2 = RingSplitQuality.classifyPointClosenessNeighbor(theoreticalDistance2)
        //let grade3 = RingSplitQuality.classifyPointClosenessNeighbor(theoreticalDistance3)
        //let grade4 = RingSplitQuality.classifyPointClosenessNeighbor(theoreticalDistance4)
        ...
        if neighborDistanceSquared1 < PolyMeshConstants.splitPointNeighborTooCloseToLineSegmentSquared {
            return false
        }
        ...
        if neighborDistanceSquared2 < PolyMeshConstants.splitPointNeighborTooCloseToLineSegmentSquared {
            return false
        }
        ...
        if neighborDistanceSquared3 < PolyMeshConstants.splitPointNeighborTooCloseToLineSegmentSquared {
            return false
        }
        ...
        if neighborDistanceSquared4 < PolyMeshConstants.splitPointNeighborTooCloseToLineSegmentSquared {
            return false
        }
        
        var minDistanceSquared = Float(100_000_000.0)
        if neighborDistanceSquared1 < minDistanceSquared {
            minDistanceSquared = neighborDistanceSquared1
        }
        if neighborDistanceSquared2 < minDistanceSquared {
            minDistanceSquared = neighborDistanceSquared2
        }
        if neighborDistanceSquared3 < minDistanceSquared {
            minDistanceSquared = neighborDistanceSquared3
        }
        if neighborDistanceSquared4 < minDistanceSquared {
            minDistanceSquared = neighborDistanceSquared4
        }
        
        quality.pointClosenessNeighbor = RingSplitQuality.classifyPointClosenessNeighbor(minDistanceSquared)
        */
        return true
    }
    ...
    func attemptMeasureSplitQualityPointClosenessDistant(index1: Int,
        ...
        if TOOL_MARKUP_1_ENABLED {
            ...
            //let minX = min(splitRingPoint1.x, splitRingPoint2.x) - PolyMeshConstants.ringSplitDistance - Math.epsilon
            //let maxX = max(splitRingPoint1.x, splitRingPoint2.x) + PolyMeshConstants.ringSplitDistance + Math.epsilon
            //let minY = min(splitRingPoint1.y, splitRingPoint2.y) - PolyMeshConstants.ringSplitDistance - Math.epsilon
            //let maxY = max(splitRingPoint1.y, splitRingPoint2.y) + PolyMeshConstants.ringSplitDistance + Math.epsilon
