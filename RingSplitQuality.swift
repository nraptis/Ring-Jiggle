...
struct RingSplitQuality: Hashable, CustomStringConvertible {
    ...
    static let splitQualityPointClosenessNeighborThresholdGreat = Float(14.0)
    static let splitQualityPointClosenessNeighborThresholdGood = Float(12.0)
    static let splitQualityPointClosenessNeighborThresholdNormal = Float(10.0)
    static let splitQualityPointClosenessNeighborThresholdLow = Float(8.0)
    static let splitQualityPointClosenessNeighborThresholdBroken = Float(6.0)
    ...
    static let splitQualityPointClosenessDistantThresholdGreat = Float(20.0)
    static let splitQualityPointClosenessDistantThresholdGood = Float(18.0)
    static let splitQualityPointClosenessDistantThresholdNormal = Float(16.0)
    static let splitQualityPointClosenessDistantThresholdLow = Float(14.0)
    static let splitQualityPointClosenessDistantThresholdBroken = Float(12.0)
    ...
    static let splitQualityLengthMaxThresholdGreat = PolyMeshConstants.ringSplitDistance + 4.0
    static let splitQualityLengthMaxThresholdGood = PolyMeshConstants.ringSplitDistance + 7.0
    static let splitQualityLengthMaxThresholdNormal = PolyMeshConstants.ringSplitDistance + 10.0
    static let splitQualityLengthMaxThresholdLow = PolyMeshConstants.ringSplitDistance + 13.0
    static let splitQualityLengthMaxThresholdBroken = PolyMeshConstants.ringSplitDistance + 16.0
    
    static let splitQualityLengthMinThresholdGreat = Float(16.0)
    static let splitQualityLengthMinThresholdGood = Float(14.0)
    static let splitQualityLengthMinThresholdNormal = Float(12.0)
    static let splitQualityLengthMinThresholdLow = Float(10.0)
    static let splitQualityLengthMinThresholdBroken = Float(8.0)
