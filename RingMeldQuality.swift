...
//  Jiggle3
//
//  Created by Nicky Taylor on 1/17/24.
//
...
struct RingMeldQuality: CustomStringConvertible, Hashable {
    ...
    static let meldQualityDistanceFromOriginalCenterBroken = Float(6.0)
    static let meldQualityDistanceFromOriginalCenterLow = Float(5.0)
    static let meldQualityDistanceFromOriginalCenterNormal = Float(4.0)
    static let meldQualityDistanceFromOriginalCenterGood = Float(3.0)
    static let meldQualityDistanceFromOriginalCenterGreat = Float(2.0)
    
    static let meldQualityMaxDistanceToLineSegmentBroken = Float(24.0)
    static let meldQualityMaxDistanceToLineSegmentLow = Float(22.0)
    static let meldQualityMaxDistanceToLineSegmentNormal = Float(20.0)
    static let meldQualityMaxDistanceToLineSegmentGood = Float(18.0)
    static let meldQualityMaxDistanceToLineSegmentGreat = Float(16.0)
    
    static let meldQualityMaxSpokeLengthBroken = Float(36.0)
    static let meldQualityMaxSpokeLengthLow = Float(32.0)
    static let meldQualityMaxSpokeLengthNormal = Float(28.0)
    static let meldQualityMaxSpokeLengthGood = Float(24.0)
    static let meldQualityMaxSpokeLengthGreat = Float(20.0)
    ...
    static let meldQualityMaxEdgeLengthBroken = Float(24.0)
    static let meldQualityMaxEdgeLengthLow = Float(22.0)
    static let meldQualityMaxEdgeLengthNormal = Float(20.0)
    static let meldQualityMaxEdgeLengthGood = Float(18.0)
    static let meldQualityMaxEdgeLengthGreat = Float(16.0)
    
    static func classifyDistanceFromOriginalCenter(_ distanceSquared: Float) -> QualityGrade {
        if distanceSquared > (Self.meldQualityDistanceFromOriginalCenterBroken * Self.meldQualityDistanceFromOriginalCenterBroken) {
            return .broken
        } else if distanceSquared > (Self.meldQualityDistanceFromOriginalCenterLow * Self.meldQualityDistanceFromOriginalCenterLow) {
            return .low
        } else if distanceSquared > (Self.meldQualityDistanceFromOriginalCenterNormal * Self.meldQualityDistanceFromOriginalCenterNormal) {
            return .normal
        } else if distanceSquared > (Self.meldQualityDistanceFromOriginalCenterGood * Self.meldQualityDistanceFromOriginalCenterGood) {
            return .good
        } else if distanceSquared > (Self.meldQualityDistanceFromOriginalCenterGreat * Self.meldQualityDistanceFromOriginalCenterGreat) {
            return .great
        } else {
            return .excellent
        }
...
extension RingMeldQuality: Comparable {
    ...
    static func weightMinDistanceToLineSegment(_ meldQuality: QualityGrade) -> Int {
        switch meldQuality {
        case .excellent:
            return 9_000_000
        case .great:
    ...
    static func weightMinSpokeLength(_ meldQuality: QualityGrade) -> Int {
        switch meldQuality {
        case .excellent:
            return 9_000_000
        case .great:
