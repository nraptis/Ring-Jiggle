...
extension Ring {
    ...
    func meldReplaceProbePointRangeWithOneProbePoint(startIndex: Int, endIndex: Int, _ ringProbePoint: RingProbePoint) {
        ...
        if startIndex < 0 {
            print("[KJ191] meldReplaceProbePointRangeWithOneProbePoint bad start index \(startIndex) / \(ringProbePointCount)")
            return
        }
        if startIndex >= ringProbePointCount {
            print("[KJ192] meldReplaceProbePointRangeWithOneProbePoint bad start index \(startIndex) / \(ringProbePointCount)")
            return
        }
        if endIndex < 0 {
            print("[KJ193] meldReplaceProbePointRangeWithOneProbePoint bad end index \(startIndex) / \(ringProbePointCount)")
            return
        }
        if endIndex >= ringProbePointCount {
            print("[KJ194] meldReplaceProbePointRangeWithOneProbePoint bad end index \(startIndex) / \(ringProbePointCount)")
            return
        }
    ...
    func meldReplaceProbeSegmentRangeWithTwoProbeSegments(startIndex: Int,
        ...
        if startIndex < 0 {
            print("[PIO192] meldReplaceProbeSegmentRangeWithTwoProbeSegments bad start index \(startIndex) / \(ringProbeSegmentCount)")
            return
        }
        if startIndex >= ringProbeSegmentCount {
            print("[PIO193] meldReplaceProbeSegmentRangeWithTwoProbeSegments bad start index \(startIndex) / \(ringProbeSegmentCount)")
            return
        }
        if endIndex < 0 {
            print("[PIO194] meldReplaceProbeSegmentRangeWithTwoProbeSegments bad end index \(startIndex) / \(ringProbeSegmentCount)")
            return
        }
        if endIndex >= ringProbeSegmentCount {
            print("[PIO195] meldReplaceProbeSegmentRangeWithTwoProbeSegments bad end index \(startIndex) / \(ringProbeSegmentCount)")
            return
        }
        ...
        if startIndex > endIndex {
            ...
            if endIndex == startIndex {
                print("[PXP9] meldReplaceProbeSegmentRangeWithTwoProbeSegments we do not support startIndex \(startIndex) == endIndex \(endIndex)")
                return
            } else {
